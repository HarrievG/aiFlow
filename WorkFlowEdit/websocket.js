...
export function initWebSocket(url) {
	...
	websocket.onopen = () => {
		...
		// Once connected, load the initial data (e.g., list workflows)
		sendApiRequest('listWorkflows', {}, renderWorkflowList);
		// Maybe show the home view if not already there
...
export function sendApiRequest(command, payload = {}, callback = null) {
...
export function unsubscribeFromEvent(eventType, callback) {
	if (eventListeners.has(eventType)) {
